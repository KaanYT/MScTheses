...
\begin{figure}[htbp]
\centering
\fbox{\includegraphics[width=.9\columnwidth]{figures/PredictionModuleSequenceDiagram.png}}
...
\begin{figure}[htbp]
\centering
\fbox{\includegraphics[width=.4\columnwidth]{figures/UserApplicationValidations.png}}
...
\begin{figure}[htbp]
\centering
\fbox{\includegraphics[width=.6\columnwidth]{figures/BatchProcessPerspectiveTransformation.png}}
...
\begin{figure}[htbp]
\centering
\fbox{\includegraphics[width=0.98\columnwidth]{figures/DatabaseGeneralView.png}}
...
\begin{figure}[htbp]
\centering
\fbox{\includegraphics[width=.7\columnwidth]{figures/DatabaseUser.png}}
