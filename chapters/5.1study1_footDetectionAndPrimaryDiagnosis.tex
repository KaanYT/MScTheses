...
\begin{figure}[htbp]
\centering
\fbox{\includegraphics[width=.80\columnwidth]{figures/PredictionModuleSequenceDiagram.png}}
...
\begin{figure}[htbp]
\centering
\fbox{\includegraphics[width=.71\columnwidth]{figures/FineTuneModuleWebApplicationSequenceDiagram.png}}
\caption{Fine-tune module web application activity diagram}
...
\begin{figure}[htbp]
\centering
\fbox{\includegraphics[width=.75\columnwidth]{figures/UserApplicationUI.png}}
...
\begin{figure}[htbp]
\centering
\fbox{\includegraphics[width=.35\columnwidth]{figures/UserApplicationValidations.png}}
...
\begin{figure}[htbp]
\centering
\fbox{\includegraphics[width=.9\columnwidth]{figures/UserApplicationOnboarding.png}}
...
\begin{figure}[htbp]
\centering
\fbox{\includegraphics[width=.55\columnwidth]{figures/UserApplicationFeedback.png}}
...
\begin{figure}[htbp]
\centering
\fbox{\includegraphics[width=.7\columnwidth]{figures/WebApplicationPatientInfo.png}}
...
\begin{figure}[htbp]
\centering
\fbox{\includegraphics[width=.8\columnwidth]{figures/WebApplicationFootPoints.png}}
...
\begin{figure}[htbp]
\centering
\fbox{\includegraphics[width=.9\columnwidth]{figures/WebApplicationSetFootDeformity.png}}
...
\begin{figure}[htbp]
\centering
\fbox{\includegraphics[width=.6\columnwidth]{figures/WebApplicationCriticalPointAssistance.png}}
...
\begin{figure}[htbp]
\centering
\fbox{\includegraphics[width=.6\columnwidth]{figures/WebApplicationInformationBoxes.png}}
...
\begin{figure}[htbp]
\centering
\fbox{\includegraphics[width=.7\columnwidth]{figures/DeepLearningTest.jpeg}}
...
\begin{figure}[htbp]
\centering
\fbox{\includegraphics[width=.6\columnwidth]{figures/BatchProcessMinimumBoundingBox.png}}
...
\begin{figure}[htbp]
\centering
\fbox{\includegraphics[width=.50\columnwidth]{figures/BatchProcessPerspectiveTransformation.png}}
...
\begin{figure}[htbp]
\centering
\fbox{\includegraphics[width=.6\columnwidth]{figures/BatchProcessSobelOutput.jpg}}
...
\begin{figure}[htbp]
\centering
\fbox{\includegraphics[width=.6\columnwidth]{figures/BatchProcessEdge.jpeg}}
...
\begin{figure}[htbp]
\centering
\fbox{\includegraphics[width=.6\columnwidth]{figures/BatchProcessLine.jpeg}}
...
\label{alg:pca}
\hspace{1cm}\framebox[13.5cm][c]{\begin{minipage}{13.25cm}
\begin{algorithmic}[0]
...
\begin{figure}[htbp]
\centering
\fbox{\includegraphics[width=0.90\columnwidth]{figures/DatabaseGeneralView.png}}
...
\begin{figure}[htbp]
\centering
\fbox{\includegraphics[width=.65\columnwidth]{figures/DatabaseUser.png}}
...
\begin{figure}[htbp]
\centering
\fbox{\includegraphics[width=.9\columnwidth]{figures/DatabaseDiagnosis.png}}
...
\begin{figure}[htbp]
\centering
\fbox{\includegraphics[width=.7\columnwidth]{figures/DatabaseFiles.png}}
...
\begin{figure}[htbp]
\centering
\fbox{\includegraphics[width=.65\columnwidth]{figures/StudyIParticipantsBMITypeDistribution.png}}
...
\begin{figure}[htbp]
\centering
\fbox{\includegraphics[width=.65\columnwidth]{figures/StudyICriticalPointResult.png}}
...
\begin{figure}[htbp]
\centering
\fbox{\includegraphics[width=.65\columnwidth]{figures/StudyIIndexErrorNormalDists.png}}
...
\begin{figure}[htbp]
\centering
\fbox{\includegraphics[width=.65\columnwidth]{figures/StudyILenghtErrorNormalDists.png}}
