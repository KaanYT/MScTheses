...
\begin{figure}[htbp]
\centering
\fbox{\includegraphics[width=.6\columnwidth]{figures/MethodologyCalcaneusInclinationAngle.png}}
...
\begin{figure}[htbp]
\centering
\fbox{\includegraphics[width=.6\columnwidth]{figures/MethodologyMetatarsalDeclinationAngle.png}}
...
\begin{figure}[htbp]
\centering
\fbox{\includegraphics[width=.6\columnwidth]{figures/MethodologyMearysAngle.jpg}}
...
\begin{figure}[htbp]
\centering
\fbox{\includegraphics[width=.6\columnwidth]{figures/MethodologyLateralTalocalcanealAngle.png}}
...
\begin{figure}[htbp]
\centering
\fbox{\includegraphics[width=.2\columnwidth]{figures/MethodologyStaheliIndex.png}}
...
\begin{figure}[htbp]
\centering
\fbox{\includegraphics[width=.25\columnwidth]{figures/MethodologyChippauxSmirakaIndex.png}}
...
\begin{figure}[htbp]
\centering
\fbox{\includegraphics[width=.25\columnwidth]{figures/MethodologyClarkesAngle.png}}
...
\begin{figure}[htbp]
\centering
\fbox{\includegraphics[width=.25\columnwidth]{figures/MethodologyArchIndex.png}}
...
\begin{figure}[htbp]
\centering
\fbox{\includegraphics[width=.50\columnwidth]{figures/MethodologyArchHeightIndex.png}}
...
\begin{figure}[htbp]
\centering
\fbox{\includegraphics[width=.30\columnwidth]{figures/MethodologyRearfootAngle.jpg}}
...
\begin{figure}[htbp]
\centering
\fbox{\includegraphics[width=.60\columnwidth]{figures/MethodologyArtificialNeural.jpg}}
...
\begin{figure}[htbp]
\centering
\fbox{\includegraphics[width=.60\columnwidth]{figures/MethodologyArtificialNeuralNetwork.jpg}}
...
\begin{figure}[htbp]
\centering
\fbox{\includegraphics[width=.60\columnwidth]{figures/MethodologyRecurrentNeuralNetwork.jpg}}
...
\begin{figure}[htbp]
\centering
\fbox{\includegraphics[width=.60\columnwidth]{figures/MethodologyConvolutionalNeuralNetworkExample.jpg}}
