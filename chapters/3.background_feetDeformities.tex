...
\begin{figure}[htbp]
\centering
\fbox{\includegraphics[width=.8\columnwidth]{figures/BackgroundPesPlanus.png}}
...
\begin{figure}[htbp]
\centering
\fbox{\includegraphics[width=.8\columnwidth]{figures/BackgroundPesCavus.jpg}}
...
\begin{figure}[htbp]
\centering
\fbox{\includegraphics[width=.4\columnwidth]{figures/BackgroundExampleEmed.jpg}}
